...
URL Source: https://docs.openclaw.ai/reference/credits
...
# [​](https://docs.openclaw.ai/reference/credits#credits-and-acknowledgments)

Credits and Acknowledgments

## [​](https://docs.openclaw.ai/reference/credits#the-name)

The name

OpenClaw = CLAW + TARDIS, because every space lobster needs a time and space machine.
## [​](https://docs.openclaw.ai/reference/credits#credits)
...
## [​](https://docs.openclaw.ai/reference/credits#core-contributors)
...
## [​](https://docs.openclaw.ai/reference/credits#license)
