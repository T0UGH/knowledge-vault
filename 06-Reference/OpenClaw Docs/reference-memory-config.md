...
URL Source: https://docs.openclaw.ai/reference/memory-config
...
*   [Memory configuration reference](https://docs.openclaw.ai/reference/memory-config#memory-configuration-reference)
*   [Memory search defaults](https://docs.openclaw.ai/reference/memory-config#memory-search-defaults)
*   [QMD backend (experimental)](https://docs.openclaw.ai/reference/memory-config#qmd-backend-experimental)
*   [Prerequisites](https://docs.openclaw.ai/reference/memory-config#prerequisites)
*   [How the sidecar runs](https://docs.openclaw.ai/reference/memory-config#how-the-sidecar-runs)
*   [Config surface (memory.qmd.*)](https://docs.openclaw.ai/reference/memory-config#config-surface-memory-qmd)
*   [QMD example](https://docs.openclaw.ai/reference/memory-config#qmd-example)
*   [Citations and fallback](https://docs.openclaw.ai/reference/memory-config#citations-and-fallback)
*   [Additional memory paths](https://docs.openclaw.ai/reference/memory-config#additional-memory-paths)
*   [Multimodal memory files (Gemini image + audio)](https://docs.openclaw.ai/reference/memory-config#multimodal-memory-files-gemini-image-%2B-audio)
*   [Gemini embeddings (native)](https://docs.openclaw.ai/reference/memory-config#gemini-embeddings-native)
*   [Gemini Embedding 2 (preview)](https://docs.openclaw.ai/reference/memory-config#gemini-embedding-2-preview)
*   [Custom OpenAI-compatible endpoint](https://docs.openclaw.ai/reference/memory-config#custom-openai-compatible-endpoint)
*   [Fallbacks](https://docs.openclaw.ai/reference/memory-config#fallbacks)
*   [Batch indexing](https://docs.openclaw.ai/reference/memory-config#batch-indexing)
*   [How the memory tools work](https://docs.openclaw.ai/reference/memory-config#how-the-memory-tools-work)
*   [What gets indexed (and when)](https://docs.openclaw.ai/reference/memory-config#what-gets-indexed-and-when)
*   [Hybrid search (BM25 + vector)](https://docs.openclaw.ai/reference/memory-config#hybrid-search-bm25-%2B-vector)
*   [Why hybrid](https://docs.openclaw.ai/reference/memory-config#why-hybrid)
*   [How we merge results (the current design)](https://docs.openclaw.ai/reference/memory-config#how-we-merge-results-the-current-design)
*   [Post-processing pipeline](https://docs.openclaw.ai/reference/memory-config#post-processing-pipeline)
*   [MMR re-ranking (diversity)](https://docs.openclaw.ai/reference/memory-config#mmr-re-ranking-diversity)
*   [Temporal decay (recency boost)](https://docs.openclaw.ai/reference/memory-config#temporal-decay-recency-boost)
*   [Hybrid search configuration](https://docs.openclaw.ai/reference/memory-config#hybrid-search-configuration)
...
*   [Local embedding auto-download](https://docs.openclaw.ai/reference/memory-config#local-embedding-auto-download)
*   [Custom OpenAI-compatible endpoint example](https://docs.openclaw.ai/reference/memory-config#custom-openai-compatible-endpoint-example)
...
## [​](https://docs.openclaw.ai/reference/memory-config#memory-search-defaults)
...
*   `memorySearch.provider` and `memorySearch.fallback` accept **adapter ids** registered by the active memory plugin.
*   The default `memory-core` plugin registers these built-in adapter ids: `local`, `openai`, `gemini`, `voyage`, `mistral`, and `ollama`.
*   With the default `memory-core` plugin, if `memorySearch.provider` is not set, OpenClaw auto-selects:
...
*   With the default `memory-core` plugin, `memorySearch.provider = "ollama"` is also supported for local/self-hosted Ollama embeddings (`/api/embeddings`), but it is not auto-selected.
...
## [​](https://docs.openclaw.ai/reference/memory-config#qmd-backend-experimental)
...
### [​](https://docs.openclaw.ai/reference/memory-config#prerequisites)
...
### [​](https://docs.openclaw.ai/reference/memory-config#how-the-sidecar-runs)
...
### [​](https://docs.openclaw.ai/reference/memory-config#config-surface-memory-qmd)
...
### [​](https://docs.openclaw.ai/reference/memory-config#qmd-example)
...
### [​](https://docs.openclaw.ai/reference/memory-config#citations-and-fallback)
...
## [​](https://docs.openclaw.ai/reference/memory-config#additional-memory-paths)
...
## [​](https://docs.openclaw.ai/reference/memory-config#multimodal-memory-files-gemini-image-+-audio)
...
## [​](https://docs.openclaw.ai/reference/memory-config#gemini-embeddings-native)
...
### [​](https://docs.openclaw.ai/reference/memory-config#gemini-embedding-2-preview)
...
## [​](https://docs.openclaw.ai/reference/memory-config#custom-openai-compatible-endpoint)
...
### [​](https://docs.openclaw.ai/reference/memory-config#fallbacks)
...
### [​](https://docs.openclaw.ai/reference/memory-config#batch-indexing)
...
## [​](https://docs.openclaw.ai/reference/memory-config#how-the-memory-tools-work)
...
## [​](https://docs.openclaw.ai/reference/memory-config#what-gets-indexed-and-when)
...
## [​](https://docs.openclaw.ai/reference/memory-config#hybrid-search-bm25-+-vector)
...
### [​](https://docs.openclaw.ai/reference/memory-config#why-hybrid)
...
### [​](https://docs.openclaw.ai/reference/memory-config#how-we-merge-results-the-current-design)
...
### [​](https://docs.openclaw.ai/reference/memory-config#post-processing-pipeline)
...
### [​](https://docs.openclaw.ai/reference/memory-config#mmr-re-ranking-diversity)
...
### [​](https://docs.openclaw.ai/reference/memory-config#temporal-decay-recency-boost)
...
### [​](https://docs.openclaw.ai/reference/memory-config#hybrid-search-configuration)
...
## [​](https://docs.openclaw.ai/reference/memory-config#embedding-cache)
...
## [​](https://docs.openclaw.ai/reference/memory-config#session-memory-search-experimental)
...
## [​](https://docs.openclaw.ai/reference/memory-config#local-embedding-auto-download)
...
## [​](https://docs.openclaw.ai/reference/memory-config#custom-openai-compatible-endpoint-example)
...
[Transcript Hygiene](https://docs.openclaw.ai/reference/transcript-hygiene)[Date and Time](https://docs.openclaw.ai/date-time)
