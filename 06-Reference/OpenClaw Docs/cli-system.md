...
URL Source: https://docs.openclaw.ai/cli/system
...
# [​](https://docs.openclaw.ai/cli/system#openclaw-system)

`openclaw system`

System-level helpers for the Gateway: enqueue system events, control heartbeats, and view presence.
## [​](https://docs.openclaw.ai/cli/system#common-commands)
...
## [​](https://docs.openclaw.ai/cli/system#system-event)
...
## [​](https://docs.openclaw.ai/cli/system#system-heartbeat-last|enable|disable)
...
## [​](https://docs.openclaw.ai/cli/system#system-presence)
...
## [​](https://docs.openclaw.ai/cli/system#notes)
...
[sessions](https://docs.openclaw.ai/cli/sessions)[channels](https://docs.openclaw.ai/cli/channels)
