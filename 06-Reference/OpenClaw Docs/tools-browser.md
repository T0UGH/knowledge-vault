...
URL Source: https://docs.openclaw.ai/tools/browser
...
*   [Plugin control](https://docs.openclaw.ai/tools/browser#plugin-control)
*   [Profiles: openclaw vs user](https://docs.openclaw.ai/tools/browser#profiles-openclaw-vs-user)
...
*   [Direct WebSocket CDP providers](https://docs.openclaw.ai/tools/browser#direct-websocket-cdp-providers)
*   [Browserbase](https://docs.openclaw.ai/tools/browser#browserbase)
...
*   [Existing-session via Chrome DevTools MCP](https://docs.openclaw.ai/tools/browser#existing-session-via-chrome-devtools-mcp)
...
*   [Docker Playwright install](https://docs.openclaw.ai/tools/browser#docker-playwright-install)
...
# [​](https://docs.openclaw.ai/tools/browser#browser-openclaw-managed)
...
## [​](https://docs.openclaw.ai/tools/browser#what-you-get)
...
## [​](https://docs.openclaw.ai/tools/browser#quick-start)
...
The default `browser` tool is now a bundled plugin that ships enabled by default. That means you can disable or replace it without removing the rest of OpenClaw’s plugin system:
...
## [​](https://docs.openclaw.ai/tools/browser#local-vs-remote-control)
...
[Browserless](https://browserless.io/) is a hosted Chromium service that exposes CDP connection URLs over HTTPS and WebSocket. OpenClaw can use either form, but for a remote browser profile the simplest option is the direct WebSocket URL from Browserless’ connection docs.Example:
...
## [​](https://docs.openclaw.ai/tools/browser#direct-websocket-cdp-providers)
...
*   **WebSocket endpoints** (`ws://` / `wss://`) — OpenClaw connects directly, skipping `/json/version`. Use this for services like [Browserless](https://browserless.io/), [Browserbase](https://www.browserbase.com/), or any provider that hands you a WebSocket URL.

### [​](https://docs.openclaw.ai/tools/browser#browserbase)
...
## [​](https://docs.openclaw.ai/tools/browser#security)
...
## [​](https://docs.openclaw.ai/tools/browser#profiles-multi-browser)
...
## [​](https://docs.openclaw.ai/tools/browser#isolation-guarantees)
...
## [​](https://docs.openclaw.ai/tools/browser#browser-selection)
...
## [​](https://docs.openclaw.ai/tools/browser#control-api-optional)
...
#### [​](https://docs.openclaw.ai/tools/browser#docker-playwright-install)
...
## [​](https://docs.openclaw.ai/tools/browser#how-it-works-internal)
...
## [​](https://docs.openclaw.ai/tools/browser#cli-quick-reference)
...
*   `snapshot`:
    ...
    *   Config default (tool/CLI only): set `browser.snapshotDefaults.mode: "efficient"` to use efficient snapshots when the caller does not pass a mode (see [Gateway configuration](https://docs.openclaw.ai/gateway/configuration-reference#browser)).
...
## [​](https://docs.openclaw.ai/tools/browser#snapshots-and-refs)
...
## [​](https://docs.openclaw.ai/tools/browser#wait-power-ups)
...
## [​](https://docs.openclaw.ai/tools/browser#debug-workflows)
...
## [​](https://docs.openclaw.ai/tools/browser#json-output)
...
## [​](https://docs.openclaw.ai/tools/browser#state-and-environment-knobs)
...
## [​](https://docs.openclaw.ai/tools/browser#troubleshooting)
...
[apply_patch Tool](https://docs.openclaw.ai/tools/apply-patch)[Browser Login](https://docs.openclaw.ai/tools/browser-login)
