...
Title: Plugin SDK Overview - OpenClaw

URL Source: https://docs.openclaw.ai/plugins/sdk-overview
...
*   [Entry Points](https://docs.openclaw.ai/plugins/sdk-entrypoints) — `definePluginEntry` and `defineChannelPluginEntry` options
*   [Runtime Helpers](https://docs.openclaw.ai/plugins/sdk-runtime) — full `api.runtime` namespace reference
*   [Setup and Config](https://docs.openclaw.ai/plugins/sdk-setup) — packaging, manifests, config schemas
*   [Testing](https://docs.openclaw.ai/plugins/sdk-testing) — test utilities and lint rules
*   [SDK Migration](https://docs.openclaw.ai/plugins/sdk-migration) — migrating from deprecated surfaces
*   [Plugin Internals](https://docs.openclaw.ai/plugins/architecture) — deep architecture and capability model
