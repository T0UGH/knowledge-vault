---
title: wath_is_redis
source_url: https://www.xiaolincoding.com/redis/base/wath_is_redis.html
...
当然，这篇文章也不是把所有 Redis 功能都介绍了，如果你想了解更多 Redis 其他知识，可以看我之前写的这篇：[3 万字 + 40 张图 | 攻破 Redis 常见面试题 (opens new window)](https://xiaolincoding.com/redis/base/redis_interview.htmlt)

好了，话不多说了，发车！

[#](https://www.xiaolincoding.com#什么是-redis-2) 什么是 Redis？
...
[#](https://www.xiaolincoding.com#redis-架构) Redis 架构
...
[#](https://www.xiaolincoding.com#单个-redis-实例) 单个 Redis 实例
...
[#](https://www.xiaolincoding.com#redis-高可用性) Redis 高可用性
...
[#](https://www.xiaolincoding.com#redis-复制) Redis 复制
...
[#](https://www.xiaolincoding.com#redis-哨兵) Redis 哨兵
...
Redis Cluster 为这个问题设计了一种解决方案，称为 **Hashslot（哈希槽）**，所有数据都映射到它。有 16384 个哈希槽，所有数据根据Key 的哈希值映射到对应的槽，具体的公式：`CRC16(key) % 16384`
...
[#](https://www.xiaolincoding.com#gossiping-协议) Gossiping 协议
...
[#](https://www.xiaolincoding.com#redis-持久化模型) Redis 持久化模型
...
[#](https://www.xiaolincoding.com#无持久化) 无持久化
无持久化：如果你愿意，可以完全禁用持久化。这是运行 Redis 的最快方式，并且没有持久性保证。

[#](https://www.xiaolincoding.com#rdb文件) RDB文件
...
[#](https://www.xiaolincoding.com#aof) AOF
...
[#](https://www.xiaolincoding.com#为什么不兼得) 为什么不兼得？
...
[#](https://www.xiaolincoding.com#forking) Forking
