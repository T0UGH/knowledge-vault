---
title: 服务器 B 执行这条命令
source_url: https://www.xiaolincoding.com/redis/cluster/master_slave_replication.html
fetched_at: 2026-04-06
section: redis
---

[#](https://www.xiaolincoding.com#主从复制是怎么实现的) 主从复制是怎么实现的？
大家好，我是小林哥。
...
[#](https://www.xiaolincoding.com#第一次同步) 第一次同步
...
[#](https://www.xiaolincoding.com#命令传播) 命令传播
...
[#](https://www.xiaolincoding.com#分摊主服务器的压力) 分摊主服务器的压力
...
[#](https://www.xiaolincoding.com#增量复制) 增量复制
...
[#](https://www.xiaolincoding.com#面试题) 面试题
[#](https://www.xiaolincoding.com#redis主从节点时长连接还是短连接) Redis主从节点时长连接还是短连接？
长连接

[#](https://www.xiaolincoding.com#怎么判断-redis-某个节点是否正常工作) 怎么判断 Redis 某个节点是否正常工作？
...
-
-
[#](https://www.xiaolincoding.com#主从复制架构中-过期key如何处理) 主从复制架构中，过期key如何处理？
主节点处理了一个key或者通过淘汰算法淘汰了一个key，这个时间主节点模拟一条del命令发送给从节点，从节点收到该命令后，就进行删除key的操作。

[#](https://www.xiaolincoding.com#redis-是同步复制还是异步复制) Redis 是同步复制还是异步复制？
Redis 主节点每次收到写命令之后，先写到内部的缓冲区，然后异步发送给从节点。

[#](https://www.xiaolincoding.com#主从复制中两个-buffer-replication-buffer-、repl-backlog-buffer-有什么区别) 主从复制中两个 Buffer(replication buffer 、repl backlog buffer)有什么区别？
...
-
[#](https://www.xiaolincoding.com#如何应对主从数据不一致) 如何应对主从数据不一致？
为什么会出现主从数据不一致？
...
-
[#](https://www.xiaolincoding.com#主从切换如何减少数据丢失) 主从切换如何减少数据丢失？
...
[#](https://www.xiaolincoding.com#异步复制同步丢失) 异步复制同步丢失
...
[#](https://www.xiaolincoding.com#集群产生脑裂数据丢失) 集群产生脑裂数据丢失
...
[#](https://www.xiaolincoding.com#主从如何做到故障自动切换) 主从如何做到故障自动切换？
