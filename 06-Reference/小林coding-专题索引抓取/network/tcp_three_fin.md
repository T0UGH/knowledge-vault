...
source_url: https://www.xiaolincoding.com/network/3_tcp/tcp_three_fin.html
fetched_at: 2026-04-06
section: network
---

[#](https://www.xiaolincoding.com#_4-22-tcp-四次挥手-可以变成三次吗) 4.22 TCP 四次挥手，可以变成三次吗？
大家好，我是小林。
...
[#](https://www.xiaolincoding.com#tcp-四次挥手) TCP 四次挥手
TCP 四次挥手的过程如下：
...
[#](https://www.xiaolincoding.com#为什么-tcp-挥手需要四次呢) 为什么 TCP 挥手需要四次呢？
...
[#](https://www.xiaolincoding.com#粗暴关闭-vs-优雅关闭) 粗暴关闭 vs 优雅关闭
...
[#](https://www.xiaolincoding.com#什么情况会出现三次挥手) 什么情况会出现三次挥手？
...
```
[#](https://www.xiaolincoding.com#实验验证) 实验验证
[#](https://www.xiaolincoding.com#实验一) 实验一
接下来，来给大家做个实验，验证这个结论：

当被动关闭方（上图的服务端）在 TCP 挥手过程中，「
...
结论：当被动关闭方（上图的服务端）在 TCP 挥手过程中，「

没有数据要发送」并且「开启了 TCP 延迟确认机制（默认会开启）」，那么第二和第三次挥手就会合并传输，这样就出现了三次挥手。
[#](https://www.xiaolincoding.com#实验二) 实验二
