---
title: port
source_url: https://www.xiaolincoding.com/network/3_tcp/port.html
fetched_at: 2026-04-06
section: network
---

[#](https://www.xiaolincoding.com#_4-18-tcp-和-udp-可以使用同一个端口吗) 4.18 TCP 和 UDP 可以使用同一个端口吗？
大家好，我是小林。
...
[#](https://www.xiaolincoding.com#tcp-和-udp-可以同时绑定相同的端口吗) TCP 和 UDP 可以同时绑定相同的端口吗？
...
[#](https://www.xiaolincoding.com#多个-tcp-服务进程可以绑定同一个端口吗) 多个 TCP 服务进程可以绑定同一个端口吗？
...
[#](https://www.xiaolincoding.com#客户端的端口可以重复使用吗) 客户端的端口可以重复使用吗？
