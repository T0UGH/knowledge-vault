---
title: tcp_stream
source_url: https://www.xiaolincoding.com/network/3_tcp/tcp_stream.html
fetched_at: 2026-04-06
section: network
---

[#](https://www.xiaolincoding.com#_4-6-如何理解是-tcp-面向字节流协议) 4.6 如何理解是 TCP 面向字节流协议？
有个读者问我，这么个问题：

TCP 是面向字节流的协议，UDP 是面向报文的协议？这里的「面向字节流」和「面向报文」该如何理解。

[#](https://www.xiaolincoding.com#如何理解字节流) 如何理解字节流？
...
[#](https://www.xiaolincoding.com#如何解决粘包) 如何解决粘包？
...
自定义消息结构。
-
[#](https://www.xiaolincoding.com#固定长度的消息) 固定长度的消息
这种是最简单方法，即每个用户消息都是固定长度的，比如规定一个消息的长度是 64 个字节，当接收方接满 64 个字节，就认为这个内容是一个完整且有效的消息。

但是这种方式灵活性不高，实际中很少用。

[#](https://www.xiaolincoding.com#特殊字符作为边界) 特殊字符作为边界
...
[#](https://www.xiaolincoding.com#自定义消息结构) 自定义消息结构
