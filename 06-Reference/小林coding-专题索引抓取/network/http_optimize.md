---
title: http_optimize
source_url: https://www.xiaolincoding.com/network/2_http/http_optimize.html
fetched_at: 2026-04-06
section: network
---

[#](https://www.xiaolincoding.com#_3-2-http-1-1-如何优化) 3.2 HTTP/1.1 如何优化？
...
[#](https://www.xiaolincoding.com#如何避免发送-http-请求) 如何避免发送 HTTP 请求？
...
[#](https://www.xiaolincoding.com#如何减少-http-请求次数) 如何减少 HTTP 请求次数？
减少 HTTP 请求次数自然也就提升了 HTTP 性能，可以从这 3 个方面入手：

*减少重定向请求次数*；
*合并请求*；
*延迟发送请求*；
[#](https://www.xiaolincoding.com#减少重定向请求次数) 减少重定向请求次数
我们先来看看什么是**重定向请求**？
...
[#](https://www.xiaolincoding.com#合并请求) 合并请求
...
*无损压缩*；
*有损压缩*；
[#](https://www.xiaolincoding.com#无损压缩) 无损压缩
...
[#](https://www.xiaolincoding.com#有损压缩) 有损压缩
