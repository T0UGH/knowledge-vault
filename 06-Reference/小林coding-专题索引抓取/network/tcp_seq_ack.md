---
title: tcp_seq_ack
source_url: https://www.xiaolincoding.com/network/3_tcp/tcp_seq_ack.html
fetched_at: 2026-04-06
section: network
---

[#](https://www.xiaolincoding.com#_4-23-tcp-序列号和确认号是如何变化的) 4.23 TCP 序列号和确认号是如何变化的？
大家好，我是小林。
...
-
[#](https://www.xiaolincoding.com#万能公式) 万能公式
我根据经验总结了一条万能公式。
...
-
[#](https://www.xiaolincoding.com#三次握手阶段的变化) 三次握手阶段的变化
...
[#](https://www.xiaolincoding.com#数据传输阶段的变化) 数据传输阶段的变化
...
[#](https://www.xiaolincoding.com#四次挥手阶段的变化) 四次挥手阶段的变化
...
-
[#](https://www.xiaolincoding.com#实际抓包图) 实际抓包图
在这里贴一个，实际过程中的抓包图。
