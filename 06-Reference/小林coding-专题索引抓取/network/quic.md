---
title: quic
source_url: https://www.xiaolincoding.com/network/3_tcp/quic.html
fetched_at: 2026-04-06
section: network
---

[#](https://www.xiaolincoding.com#_4-17-如何基于-udp-协议实现可靠传输) 4.17 如何基于 UDP 协议实现可靠传输？
大家好，我是小林。
...
[#](https://www.xiaolincoding.com#quic-是如何实现可靠传输的) QUIC 是如何实现可靠传输的？
...
[#](https://www.xiaolincoding.com#packet-header) Packet Header
...
是每个报文独一无二的编号，它是**严格递增**的，也就是说就算 Packet N 丢失了，重传的 Packet N 的 Packet Number 已经不是 N，而是一个比 N 大的值。
...
-
[#](https://www.xiaolincoding.com#quic-frame-header) QUIC Frame Header
...
[#](https://www.xiaolincoding.com#quic-是如何解决-tcp-队头阻塞问题的) QUIC 是如何解决 TCP 队头阻塞问题的？
[#](https://www.xiaolincoding.com#什么是-tcp-队头阻塞问题) 什么是 TCP 队头阻塞问题？
...
[#](https://www.xiaolincoding.com#http-2-的队头阻塞) HTTP/2 的队头阻塞
...
[#](https://www.xiaolincoding.com#没有队头阻塞的-quic) 没有队头阻塞的 QUIC
...
[#](https://www.xiaolincoding.com#quic-是如何做流量控制的) QUIC 是如何做流量控制的？
...
[#](https://www.xiaolincoding.com#stream-级别的流量控制) Stream 级别的流量控制
...
[#](https://www.xiaolincoding.com#connection-流量控制) Connection 流量控制
...
```
[#](https://www.xiaolincoding.com#quic-对拥塞控制改进) QUIC 对拥塞控制改进
...
[#](https://www.xiaolincoding.com#quic-更快的连接建立) QUIC 更快的连接建立
...
[#](https://www.xiaolincoding.com#quic-是如何迁移连接的) QUIC 是如何迁移连接的？
