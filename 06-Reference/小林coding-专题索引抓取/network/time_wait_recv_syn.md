...
source_url: https://www.xiaolincoding.com/network/3_tcp/time_wait_recv_syn.html
fetched_at: 2026-04-06
section: network
---

[#](https://www.xiaolincoding.com#_4-11-在-time-wait-状态的-tcp-连接-收到-syn-后会发生什么) 4.11 在 TIME_WAIT 状态的 TCP 连接，收到 SYN 后会发生什么？
大家好，我是小林。
...
[#](https://www.xiaolincoding.com#先说结论) 先说结论
...
[#](https://www.xiaolincoding.com#收到合法-syn) 收到合法 SYN
...
[#](https://www.xiaolincoding.com#收到非法的-syn) 收到非法的 SYN
...
[#](https://www.xiaolincoding.com#源码分析) 源码分析
...
接收到报文后，会调用 `__inet_lookup_skb()`
函数查找对应的 sock 结构；
-
如果连接的状态是 `TIME_WAIT`
，会跳转到 do_time_wait 处理；
-
由 `tcp_timewait_state_process()`
...
[#](https://www.xiaolincoding.com#在-time-wait-状态-收到-rst-会断开连接吗) 在 TIME_WAIT 状态，收到 RST 会断开连接吗？
