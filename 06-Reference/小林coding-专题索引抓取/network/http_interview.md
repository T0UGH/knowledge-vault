...
source_url: https://www.xiaolincoding.com/network/2_http/http_interview.html
fetched_at: 2026-04-06
section: network
---

[#](https://www.xiaolincoding.com#_3-1-http-常见面试题) 3.1 HTTP 常见面试题
...
-
[#](https://www.xiaolincoding.com#http-基本概念) HTTP 基本概念
[#](https://www.xiaolincoding.com#http-是什么) HTTP 是什么？
...
[#](https://www.xiaolincoding.com#http-常见的状态码有哪些) HTTP 常见的状态码有哪些？
`1xx`
类状态码属于**提示信息**，是协议处理中的一种中间状态，实际用到的比较少。
`2xx`
...
-
`4xx`
类状态码表示客户端发送的**报文有误**，服务器无法处理，也就是错误码的含义。
「
...
[#](https://www.xiaolincoding.com#http-常见字段有哪些) HTTP 常见字段有哪些？
*Host* 字段
客户端发送请求时，用来指定服务器的域名。
...
```
[#](https://www.xiaolincoding.com#get-与-post) GET 与 POST
[#](https://www.xiaolincoding.com#get-和-post-有什么区别) GET 和 POST 有什么区别？
...
[#](https://www.xiaolincoding.com#get-和-post-方法都是安全和幂等的吗) GET 和 POST 方法都是安全和幂等的吗？
先说明下安全和幂等的概念：
...
[#](https://www.xiaolincoding.com#http-缓存技术) HTTP 缓存技术
[#](https://www.xiaolincoding.com#http-缓存有哪些实现方式) HTTP 缓存有哪些实现方式？
...
[#](https://www.xiaolincoding.com#什么是强制缓存) 什么是强制缓存？
...
-
[#](https://www.xiaolincoding.com#什么是协商缓存) 什么是协商缓存？
...
-
可能有些文件是在秒级以内修改的，`If-Modified-Since`
能检查到的粒度是秒级的，使用 Etag就能够保证这种需求下客户端在 1 秒内能刷新多次；
-
...
-
-
服务器再次收到请求后，**会根据请求中的 If-None-Match 值与当前请求的资源生成的唯一标识进行比较**：**如果值相等，则返回 304 Not Modified，不会返回资源**；
如果不相等，则返回 200 状态码和返回资源，并在 Response 头部加上新的 ETag 唯一标识；
-
-
如果浏览器收到 304 的请求响应状态码，则会从本地缓存中加载资源，否则更新资源。
-
[#](https://www.xiaolincoding.com#http-特性) HTTP 特性
到目前为止，HTTP 常见到版本有 HTTP/1.1，HTTP/2.0，HTTP/3.0，不同版本的 HTTP 特性是不一样的。

这里先用 HTTP/1.1 版本给大家介绍，其他版本的后续也会介绍。

[#](https://www.xiaolincoding.com#http-1-1-的优点有哪些) HTTP/1.1 的优点有哪些？
...
[#](https://www.xiaolincoding.com#http-1-1-的缺点有哪些) HTTP/1.1 的缺点有哪些？
...
[#](https://www.xiaolincoding.com#http-1-1-的性能如何) HTTP/1.1 的性能如何？
...
[#](https://www.xiaolincoding.com#http-与-https) HTTP 与 HTTPS
[#](https://www.xiaolincoding.com#http-与-https-有哪些区别) HTTP 与 HTTPS 有哪些区别？
...
[#](https://www.xiaolincoding.com#https-解决了-http-的哪些问题) HTTPS 解决了 HTTP 的哪些问题？
HTTP 由于是明文传输，所以安全上存在以下三个风险：

**窃听风险**，比如通信链路上可以获取通信内容，用户号容易没。
**篡改风险**，比如强制植入垃圾广告，视觉污染，用户眼容易瞎。
**冒充风险**，比如冒充淘宝网站，用户钱容易没。
HTTP**S** 在 HTTP 与 TCP 层之间加入了 `SSL/TLS`
协议，可以很好的解决了上述的风险：
...
[#](https://www.xiaolincoding.com#https-是如何建立连接的-其间交互了什么) HTTPS 是如何建立连接的？其间交互了什么？
SSL/TLS 协议基本流程：
...
[#](https://www.xiaolincoding.com#https-的应用数据是如何保证完整性的) HTTPS 的应用数据是如何保证完整性的？
...
[#](https://www.xiaolincoding.com#https-一定安全可靠吗) HTTPS 一定安全可靠吗？
...
[#](https://www.xiaolincoding.com#http-1-1、http-2、http-3-演变) HTTP/1.1、HTTP/2、HTTP/3 演变
[#](https://www.xiaolincoding.com#http-1-1-相比-http-1-0-提高了什么性能) HTTP/1.1 相比 HTTP/1.0 提高了什么性能？
...
-
[#](https://www.xiaolincoding.com#http-2-做了什么优化) HTTP/2 做了什么优化？
...
这就是所谓的 `HPACK`
算法：在客户端和服务器同时维护一张头信息表，所有字段都会存入这个表，生成一个索引号，以后就不发送同样字段了，只发送索引号，这样就**提高速度**了。
...
最前面的 1 标识该 Header 是静态表中已经存在的 KV。（至于什么是静态表，可以看这篇：[HTTP/2 牛逼在哪？ (opens new window)](https://xiaolincoding.com/network/2_http/http2.html)）
-
...
[#](https://www.xiaolincoding.com#http-3-做了哪些优化) HTTP/3 做了哪些优化？
...
本文的 `30`
张图片，都是从一条线两条线画出来，灰常的费劲，深切感受到画图也是个**体力活**啊！
