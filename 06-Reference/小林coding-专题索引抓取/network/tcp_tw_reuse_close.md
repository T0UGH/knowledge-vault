...
source_url: https://www.xiaolincoding.com/network/3_tcp/tcp_tw_reuse_close.html
fetched_at: 2026-04-06
section: network
---

[#](https://www.xiaolincoding.com#_4-14-tcp-tw-reuse-为什么默认是关闭的) 4.14 tcp_tw_reuse 为什么默认是关闭的？
大家好，我是小林。
...
[#](https://www.xiaolincoding.com#什么是-time-wait-状态) 什么是 TIME_WAIT 状态？
TCP 四次挥手过程，如下图：
...
[#](https://www.xiaolincoding.com#为什么要设计-time-wait-状态) 为什么要设计 TIME_WAIT 状态？
...
-
[#](https://www.xiaolincoding.com#原因一-防止历史连接中的数据-被后面相同四元组的连接错误的接收) 原因一：防止历史连接中的数据，被后面相同四元组的连接错误的接收
...
[#](https://www.xiaolincoding.com#原因二-保证「被动关闭连接」的一方-能被正确的关闭) 原因二：保证「被动关闭连接」的一方，能被正确的关闭
...
[#](https://www.xiaolincoding.com#tcp-tw-reuse-是什么) tcp_tw_reuse 是什么？
...
```
**如果客户端（主动关闭连接方）的 TIME_WAIT 状态过多**，占满了所有端口资源，那么就无法对「目的 IP+ 目的 PORT」都一样的服务器发起连接了，但是被使用的端口，还是可以继续对另外一个服务器发起连接的。具体可以看我这篇文章：[客户端的端口可以重复使用吗？ (opens new window)](https://xiaolincoding.com/network/3_tcp/port.html#%E5%AE%A2%E6%88%B7%E7%AB%AF%E7%9A%84%E7%AB%AF%E5%8F%A3%E5%8F%AF%E4%BB%A5%E9%87%8D%E5%A4%8D%E4%BD%BF%E7%94%A8%E5%90%97)
...
[#](https://www.xiaolincoding.com#为什么-tcp-tw-reuse-默认是关闭的) 为什么 tcp_tw_reuse 默认是关闭的？
通过前面这么多铺垫，终于可以说这个问题了。

开启 tcp_tw_reuse 会有什么风险呢？我觉得会有 2 个问题。

[#](https://www.xiaolincoding.com#第一个问题) 第一个问题
...
[#](https://www.xiaolincoding.com#第二个问题) 第二个问题
