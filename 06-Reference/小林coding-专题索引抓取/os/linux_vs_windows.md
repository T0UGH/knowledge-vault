...
source_url: https://www.xiaolincoding.com/os/2_os_structure/linux_vs_windows.html
fetched_at: 2026-04-06
section: os
---

[#](https://www.xiaolincoding.com#_3-1-linux-内核-vs-windows-内核) 3.1 Linux 内核 vs Windows 内核
...
[#](https://www.xiaolincoding.com#内核) 内核
什么是内核呢？
...
[#](https://www.xiaolincoding.com#linux-的设计) Linux 的设计
...
[#](https://www.xiaolincoding.com#multitask) MultiTask
...
[#](https://www.xiaolincoding.com#monolithic-kernel) Monolithic Kernel
...
[#](https://www.xiaolincoding.com#windows-设计) Windows 设计
...
Windows 的可执行文件格式叫 PE，称为**可移植执行文件**，扩展名通常是`.exe`
、`.dll`
、`.sys`
等。
