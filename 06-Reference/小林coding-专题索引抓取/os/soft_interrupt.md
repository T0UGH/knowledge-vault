---
title: soft_interrupt
source_url: https://www.xiaolincoding.com/os/1_hardware/soft_interrupt.html
fetched_at: 2026-04-06
section: os
---

[#](https://www.xiaolincoding.com#_2-6-什么是软中断) 2.6 什么是软中断？
今日的技术主题：**什么是软中断？**。

[#](https://www.xiaolincoding.com#中断是什么) 中断是什么？
...
[#](https://www.xiaolincoding.com#什么是软中断) 什么是软中断？
...
[#](https://www.xiaolincoding.com#系统里有哪些软中断) 系统里有哪些软中断？
...
第三点，这些数值是系统运行以来的累计中断次数，数值的大小没什么参考意义，但是系统的**中断次数的变化速率**才是我们要关注的，我们可以使用 `watch -d cat /proc/softirqs`
命令查看中断次数的变化速率。
...
[#](https://www.xiaolincoding.com#如何定位软中断-cpu-使用率过高的问题) 如何定位软中断 CPU 使用率过高的问题？
