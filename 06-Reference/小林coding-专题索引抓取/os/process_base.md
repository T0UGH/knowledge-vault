---
title: process_base
source_url: https://www.xiaolincoding.com/os/4_process/process_base.html
fetched_at: 2026-04-06
section: os
---

[#](https://www.xiaolincoding.com#_5-1-进程、线程基础知识) 5.1 进程、线程基础知识
先来看看一则小故事
...
[#](https://www.xiaolincoding.com#进程) 进程
...
[#](https://www.xiaolincoding.com#进程的状态) 进程的状态
...
-
用户希望挂起一个程序的执行，比如在 Linux 中用 `Ctrl+Z`
挂起进程；
-
[#](https://www.xiaolincoding.com#进程的控制结构) 进程的控制结构
...
[#](https://www.xiaolincoding.com#进程的控制) 进程的控制
...
[#](https://www.xiaolincoding.com#进程的上下文切换) 进程的上下文切换
...
[#](https://www.xiaolincoding.com#线程) 线程
在早期的操作系统中都是以进程作为独立运行的基本单位，直到后面，计算机科学家们又提出了更小的能独立运行的基本单位，也就是**线程。**

[#](https://www.xiaolincoding.com#为什么使用线程) 为什么使用线程？
...
[#](https://www.xiaolincoding.com#什么是线程) 什么是线程？
**线程是进程当中的一条执行流程。**
...
[#](https://www.xiaolincoding.com#线程与进程的比较) 线程与进程的比较
线程与进程的比较如下：
...
[#](https://www.xiaolincoding.com#线程的上下文切换) 线程的上下文切换
...
[#](https://www.xiaolincoding.com#线程的实现) 线程的实现
主要有三种线程的实现方式：

**用户线程（**：在用户空间实现的线程，不是由内核管理的线程，是由用户态的线程库来完成线程的管理；*User Thread*）
**内核线程（**：在内核中实现的线程，是由内核管理的线程；*Kernel Thread*）
**轻量级进程（**：在内核中来支持用户线程；*LightWeight Process*）
...
[#](https://www.xiaolincoding.com#调度) 调度
...
[#](https://www.xiaolincoding.com#调度时机) 调度时机
...
[#](https://www.xiaolincoding.com#调度原则) 调度原则
...
[#](https://www.xiaolincoding.com#调度算法) 调度算法
不同的调度算法适用的场景也是不同的。
