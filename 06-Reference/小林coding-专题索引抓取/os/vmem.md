---
title: vmem
source_url: https://www.xiaolincoding.com/os/3_memory/vmem.html
fetched_at: 2026-04-06
section: os
---

[#](https://www.xiaolincoding.com#_4-1-为什么要有虚拟内存) 4.1 为什么要有虚拟内存？
本篇跟大家说说**内存管理**，内存管理还是比较重要的一个环节，理解了它，至少对整个操作系统的工作会有一个初步的轮廓，这也难怪面试的时候常问内存管理。

干就完事，本文的提纲：

[#](https://www.xiaolincoding.com#虚拟内存) 虚拟内存
...
[#](https://www.xiaolincoding.com#内存分段) 内存分段
...
[#](https://www.xiaolincoding.com#内存分页) 内存分页
...
[#](https://www.xiaolincoding.com#多级页表) 多级页表
...
-
[#](https://www.xiaolincoding.com#tlb) TLB
...
[#](https://www.xiaolincoding.com#段页式内存管理) 段页式内存管理
...
[#](https://www.xiaolincoding.com#linux-内存布局) Linux 内存布局
