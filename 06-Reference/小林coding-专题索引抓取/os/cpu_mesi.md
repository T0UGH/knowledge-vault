---
title: cpu_mesi
source_url: https://www.xiaolincoding.com/os/1_hardware/cpu_mesi.html
fetched_at: 2026-04-06
section: os
---

[#](https://www.xiaolincoding.com#_2-4-cpu-缓存一致性) 2.4 CPU 缓存一致性
直接上，不多 BB 了。

[#](https://www.xiaolincoding.com#cpu-cache-的数据写入) CPU Cache 的数据写入
...
写回（*Write Back*）
-
[#](https://www.xiaolincoding.com#写直达) 写直达
...
[#](https://www.xiaolincoding.com#写回) 写回
...
-
-
如果是脏的话，我们就要把这个 Cache Block 里的数据写回到内存，然后再把当前要写入的数据，先从内存读入到 Cache Block 里（注意，这一步不是没用的，具体为什么要这一步，可以看这个「
-
...
[#](https://www.xiaolincoding.com#缓存一致性问题) 缓存一致性问题
...
[#](https://www.xiaolincoding.com#总线嗅探) 总线嗅探
...
[#](https://www.xiaolincoding.com#mesi-协议) MESI 协议
