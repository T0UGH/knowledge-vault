...
source_url: https://www.xiaolincoding.com/os/3_memory/alloc_mem.html
fetched_at: 2026-04-06
section: os
---

[#](https://www.xiaolincoding.com#_4-4-在-4gb-物理内存的机器上-申请-8g-内存会怎么样) 4.4 在 4GB 物理内存的机器上，申请 8G 内存会怎么样？
大家好，我是小林。
...
[#](https://www.xiaolincoding.com#操作系统虚拟内存大小) 操作系统虚拟内存大小
...
[#](https://www.xiaolincoding.com#_32-位系统的场景) 32 位系统的场景
...
[#](https://www.xiaolincoding.com#_64-位系统的场景) 64 位系统的场景
...
我当时帮他排查了下，发现跟 Linux 中的 [overcommit_memory (opens new window)](http://linuxperf.com/?p=102) 参数有关，可以使用 `cat /proc/sys/vm/overcommit_memory`
来查看这个参数，这个参数接受三个值：
...
[#](https://www.xiaolincoding.com#swap-机制的作用) Swap 机制的作用
...
Swap 分区是硬盘上的独立区域，该区域只会用于交换分区，其他的文件不能存储在该区域上，我们可以使用 `swapon -s`
命令查看当前系统上的交换分区；
-
...
实验二：有开启 Swap 机制
-
[#](https://www.xiaolincoding.com#实验一-没有开启-swap-机制) 实验一：没有开启 Swap 机制
...
[#](https://www.xiaolincoding.com#实验二-有开启-swap-机制) 实验二：有开启 Swap 机制
