---
title: pagecache
source_url: https://www.xiaolincoding.com/os/6_file_system/pagecache.html
fetched_at: 2026-04-06
section: os
---

[#](https://www.xiaolincoding.com#_7-2-进程写文件时-进程发生了崩溃-已写入的数据会丢失吗) 7.2 进程写文件时，进程发生了崩溃，已写入的数据会丢失吗？
大家好，我是小林。
...
[#](https://www.xiaolincoding.com#page-cache) Page Cache
[#](https://www.xiaolincoding.com#page-cache-是什么) Page Cache 是什么？
...
[#](https://www.xiaolincoding.com#如何查看系统的-page-cache) 如何查看系统的 Page Cache？
通过读取 `/proc/meminfo`
文件，能够实时获取系统内存情况：
...
[#](https://www.xiaolincoding.com#page-与-page-cache) page 与 Page Cache
...
[#](https://www.xiaolincoding.com#swap-与缺页中断) Swap 与缺页中断
...
[#](https://www.xiaolincoding.com#page-cache-与-buffer-cache) Page Cache 与 buffer cache
...
[#](https://www.xiaolincoding.com#page-cache-与预读) Page Cache 与预读
...
[#](https://www.xiaolincoding.com#page-cache-与文件持久化的一致性-可靠性) Page Cache 与文件持久化的一致性&可靠性
...
-
[#](https://www.xiaolincoding.com#page-cache-的优劣势) Page Cache 的优劣势
[#](https://www.xiaolincoding.com#page-cache-的优势) Page Cache 的优势
**1.加快数据访问**
...
[#](https://www.xiaolincoding.com#page-cache-的劣势) Page Cache 的劣势
...
[访问局部性 (opens new window)](https://zh.wikipedia.org/wiki/%E8%AE%BF%E9%97%AE%E5%B1%80%E9%83%A8%E6%80%A7)
[DMA 与零拷贝技术 (opens new window)](https://spongecaptain.cool/SimpleClearFileIO/2.%20DMA%20%E4%B8%8E%E9%9B%B6%E6%8B%B7%E8%B4%9D%E6%8A%80%E6%9C%AF.html)
