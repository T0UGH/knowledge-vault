---
title: page
source_url: https://www.xiaolincoding.com/mysql/index/page.html
fetched_at: 2026-04-06
section: mysql
---

[#](https://www.xiaolincoding.com#从数据页的角度看-b-树) 从数据页的角度看 B+ 树
大家好，我是小林。
...
[#](https://www.xiaolincoding.com#innodb-是如何存储数据的) InnoDB 是如何存储数据的？
...
-
[#](https://www.xiaolincoding.com#b-树是如何进行查询的) B+ 树是如何进行查询的？
...
[#](https://www.xiaolincoding.com#聚簇索引和二级索引) 聚簇索引和二级索引
