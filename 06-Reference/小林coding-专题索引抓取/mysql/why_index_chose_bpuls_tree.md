---
title: why_index_chose_bpuls_tree
source_url: https://www.xiaolincoding.com/mysql/index/why_index_chose_bpuls_tree.html
fetched_at: 2026-04-06
section: mysql
---

[#](https://www.xiaolincoding.com#为什么-mysql-采用-b-树作为索引) 为什么 MySQL 采用 B+ 树作为索引？
大家好，我是小林。
...
[#](https://www.xiaolincoding.com#怎样的索引的数据结构是好的) 怎样的索引的数据结构是好的？
...
大小，操作系统一次会读写多个扇区，所以**操作系统的最小读写单位是块（Block）。Linux 中的块大小为 4KB**，也就是一次磁盘 I/O 操作会直接读写 8 个扇区。
...
[#](https://www.xiaolincoding.com#什么是二分查找) 什么是二分查找？
...
[#](https://www.xiaolincoding.com#什么是二分查找树) 什么是二分查找树？
...
[#](https://www.xiaolincoding.com#什么是自平衡二叉树) 什么是自平衡二叉树？
...
[#](https://www.xiaolincoding.com#什么是-b-树) 什么是 B 树
...
[#](https://www.xiaolincoding.com#什么是-b-树-2) 什么是 B+ 树？
...
[#](https://www.xiaolincoding.com#_1、单点查询) 1、单点查询
B 树进行单个索引查询时，最快可以在 O(1) 的时间代价内就查到，而从平均时间代价来看，会比 B+ 树稍快一些。

但是 B 树的查询波动会比较大，因为每个节点即存索引又存记录，所以有时候访问到了非叶子节点就可以找到索引，而有时需要访问到叶子节点才能找到索引。

**B+ 树的非叶子节点不存放实际的记录数据，仅存放索引，因此数据量相同的情况下，相比存储即存索引又存记录的 B 树，B+树的非叶子节点可以存放更多的索引，因此 B+ 树可以比 B 树更「矮胖」，查询底层节点的磁盘 I/O次数会更少**。
[#](https://www.xiaolincoding.com#_2、插入和删除效率) 2、插入和删除效率
...
[#](https://www.xiaolincoding.com#_3、范围查询) 3、范围查询
...
[#](https://www.xiaolincoding.com#mysql-中的-b-树) MySQL 中的 B+ 树
