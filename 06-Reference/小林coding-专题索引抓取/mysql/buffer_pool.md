---
title: buffer_pool
source_url: https://www.xiaolincoding.com/mysql/buffer_pool/buffer_pool.html
fetched_at: 2026-04-06
section: mysql
---

[#](https://www.xiaolincoding.com#揭开-buffer-pool-的面纱) 揭开 Buffer Pool 的面纱
大家好，我是小林。

今天就聊 MySQL 的 Buffer Pool，发车！

[#](https://www.xiaolincoding.com#为什么要有-buffer-pool) 为什么要有 Buffer Pool？
...
-
[#](https://www.xiaolincoding.com#buffer-pool-有多大) Buffer Pool 有多大？
...
[#](https://www.xiaolincoding.com#如何管理-buffer-pool) 如何管理 Buffer Pool？
[#](https://www.xiaolincoding.com#如何管理空闲页) 如何管理空闲页？
...
[#](https://www.xiaolincoding.com#如何管理脏页) 如何管理脏页？
...
[#](https://www.xiaolincoding.com#如何提高缓存命中率) 如何提高缓存命中率？
...
[#](https://www.xiaolincoding.com#脏页什么时候会被刷入磁盘) 脏页什么时候会被刷入磁盘？
...
-
当**「页被访问」且「 old 区域停留时间超过 `innodb_old_blocks_time`
