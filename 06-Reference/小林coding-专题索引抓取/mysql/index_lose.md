---
title: index_lose
source_url: https://www.xiaolincoding.com/mysql/index/index_lose.html
fetched_at: 2026-04-06
section: mysql
---

[#](https://www.xiaolincoding.com#索引失效有哪些) 索引失效有哪些？
大家好，我是小林。
...
[#](https://www.xiaolincoding.com#索引存储结构长什么样) 索引存储结构长什么样？
...
[#](https://www.xiaolincoding.com#对索引使用左或者左右模糊匹配) 对索引使用左或者左右模糊匹配
...
[#](https://www.xiaolincoding.com#对索引使用函数) 对索引使用函数
...
[#](https://www.xiaolincoding.com#对索引进行表达式计算) 对索引进行表达式计算
...
[#](https://www.xiaolincoding.com#对索引隐式类型转换) 对索引隐式类型转换
...
[#](https://www.xiaolincoding.com#联合索引非最左匹配) 联合索引非最左匹配
...
[#](https://www.xiaolincoding.com#where-子句中的-or) WHERE 子句中的 OR
