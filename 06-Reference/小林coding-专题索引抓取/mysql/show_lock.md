---
title: 事务 A
source_url: https://www.xiaolincoding.com/mysql/lock/show_lock.html
fetched_at: 2026-04-06
section: mysql
---

[#](https://www.xiaolincoding.com#字节面试-加了什么锁-导致死锁的) 字节面试：加了什么锁，导致死锁的？
大家好，我是小林。
...
[#](https://www.xiaolincoding.com#准备工作) 准备工作
...
[#](https://www.xiaolincoding.com#开始实验) 开始实验
在实验开始前，先说明下实验环境：
...
[#](https://www.xiaolincoding.com#为什么会发生死锁) 为什么会发生死锁？
我们可以通过 `select * from performance_schema.data_locks\G;`
这条语句，查看事务执行 SQL 过程中加了什么锁。

接下来，针对每一条 SQL 语句分析具体加了什么锁。

[#](https://www.xiaolincoding.com#time-1-阶段加锁分析) Time 1 阶段加锁分析
...
[#](https://www.xiaolincoding.com#time-2-阶段加锁分析) Time 2 阶段加锁分析
...
[#](https://www.xiaolincoding.com#time-3-阶段加锁分析) Time 3 阶段加锁分析
Time 3，事务 A 插入了一条记录：
...
-
[#](https://www.xiaolincoding.com#time-4-阶段加锁分析) Time 4 阶段加锁分析
Time 4，事务 B 插入了一条记录：
...
[#](https://www.xiaolincoding.com#读者问答) 读者问答
