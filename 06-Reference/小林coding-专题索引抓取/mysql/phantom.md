---
title: 事务 A
source_url: https://www.xiaolincoding.com/mysql/transaction/phantom.html
fetched_at: 2026-04-06
section: mysql
---

[#](https://www.xiaolincoding.com#mysql-可重复读隔离级别-完全解决幻读了吗) MySQL 可重复读隔离级别，完全解决幻读了吗？
大家好，我是小林。
...
[#](https://www.xiaolincoding.com#什么是幻读) 什么是幻读？
...
-
[#](https://www.xiaolincoding.com#快照读是如何避免幻读的) 快照读是如何避免幻读的？
...
[#](https://www.xiaolincoding.com#当前读是如何避免幻读的) 当前读是如何避免幻读的？
...
[#](https://www.xiaolincoding.com#幻读被完全解决了吗) 幻读被完全解决了吗？
**可重复读隔离级别下虽然很大程度上避免了幻读，但是还是没有能完全解决幻读**。
我举例一个可重复读隔离级别发生幻读现象的场景。

[#](https://www.xiaolincoding.com#第一个发生幻读现象的场景) 第一个发生幻读现象的场景
还是以这张表作为例子：
...
[#](https://www.xiaolincoding.com#第二个发生幻读现象的场景) 第二个发生幻读现象的场景
