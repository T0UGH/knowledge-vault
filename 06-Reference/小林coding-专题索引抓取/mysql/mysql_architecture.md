---
title: mysql_architecture
source_url: https://www.xiaolincoding.com/mysql/architecture/mysql_architecture.html
fetched_at: 2026-04-06
section: mysql
---

[#](https://www.xiaolincoding.com#mysql-架构是怎样的) MySQL 架构是怎样的？
...
[#](https://www.xiaolincoding.com#索引) 索引
...
[#](https://www.xiaolincoding.com#buffer-pool) Buffer Pool
...
[#](https://www.xiaolincoding.com#自适应-hash-索引) 自适应 hash 索引
...
比如name为 `'xiaobai' 的数据页，`
被频繁查询，那 **key** 就是 xiaobai，**value** 就是包含 xiaobai 记录的数据页的地址。

这个 hash 表，就是所谓的**自适应哈希索引**，**Adaptive Hash Index**。

[#](https://www.xiaolincoding.com#change-buffer) Change Buffer
...
[#](https://www.xiaolincoding.com#undo-log) Undo Log
...
[#](https://www.xiaolincoding.com#redo-log) Redo Log
...
[#](https://www.xiaolincoding.com#innodb-是什么) Innodb 是什么
...
[#](https://www.xiaolincoding.com#server-层是什么) Server 层是什么
...
[#](https://www.xiaolincoding.com#binlog-是什么) binlog 是什么
...
[#](https://www.xiaolincoding.com#mysql-主从架构) Mysql 主从架构
...
[#](https://www.xiaolincoding.com#数据库查询更新流程) 数据库查询更新流程
