---
title: count
source_url: https://www.xiaolincoding.com/mysql/index/count.html
fetched_at: 2026-04-06
section: mysql
---

[#](https://www.xiaolincoding.com#count-和-count-1-有什么区别-哪个性能最好) count(*) 和 count(1) 有什么区别？哪个性能最好？
大家好，我是小林。
...
[#](https://www.xiaolincoding.com#哪种-count-性能最好) 哪种 count 性能最好？
我先直接说结论：

要弄明白这个，我们得要深入 count 的原理，以下内容基于常用的 innodb 存储引擎来说明。

[#](https://www.xiaolincoding.com#count-是什么) count() 是什么？
...
[#](https://www.xiaolincoding.com#count-主键字段-执行过程是怎样的) count(主键字段) 执行过程是怎样的？
...
[#](https://www.xiaolincoding.com#count-1-执行过程是怎样的) count(1) 执行过程是怎样的？
用下面这条语句作为例子：
...
[#](https://www.xiaolincoding.com#count-执行过程是怎样的) count(*) 执行过程是怎样的？
看到 `*`
...
参数转化为参数 0 来处理。所以，**count(*) 执行过程跟 count(1) 执行过程基本一样的**，性能没有什么差异。
...
[#](https://www.xiaolincoding.com#count-字段-执行过程是怎样的) count(字段) 执行过程是怎样的？
...
[#](https://www.xiaolincoding.com#小结) 小结
...
[#](https://www.xiaolincoding.com#为什么要通过遍历的方式来计数) 为什么要通过遍历的方式来计数？
...
[#](https://www.xiaolincoding.com#如何优化-count) 如何优化 count(*)？
...
[#](https://www.xiaolincoding.com#第一种-近似值) 第一种，近似值
...
[#](https://www.xiaolincoding.com#第二种-额外表保存计数值) 第二种，额外表保存计数值
