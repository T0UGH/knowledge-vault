...
URL Source: https://code.claude.com/docs/en/desktop
...
*   Claude Code on desktop 
    ...
    *   [Use Desktop](https://code.claude.com/docs/en/desktop)
...
Remote sessions continue in the background even if you close the app. Usage counts toward your [subscription plan limits](https://code.claude.com/docs/en/costs) with no separate compute charges.You can create custom cloud environments with different network access levels and enviro
